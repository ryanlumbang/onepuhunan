        ...
        <div class="container">
            ...
            if($this->session->role_id == 'super') { ?>
                <ul class="mainnav">
                    ...
                    <li class="dropdown"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-download-alt"></i> <i class="icon-long-arrow-down"></i><span>Audit Application</span> </a>
...
<!--                            </li>-->
                    ...
                    <li class="dropdown"><a href="<?php echo site_url("dashboard"); ?>" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-cogs "></i> <i class="icon-long-arrow-down"></i><span>System Settings</span> </a>
                        <ul class="dropdown-menu">
                    ...
                    <li class="dropdown"><a href="<?php echo site_url("dashboard"); ?>" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-list-alt"></i> <i class="icon-long-arrow-down"></i><span>LOS Settings</span> </a>
                        <ul class="dropdown-menu">
